...
export class PredefinedTemplatesService {
  ...
  async initializePredefinedTemplates(): Promise<void> {
    console.log('Initializing predefined templates...');
    ...
    await this.createRowTemplates();

    // Create database templates
    await this.createDatabaseTemplates();
  ...
  // Create row templates
  private async createRowTemplates(): Promise<void> {
    const rowTemplates = [
      // Task templates
      {
        name: 'Quick Task',
  ...
  // Create database templates
  private async createDatabaseTemplates(): Promise<void> {
  ...
  // Create workspace templates
  private async createWorkspaceTemplates(): Promise<void> {
...
export const predefinedTemplatesService = new PredefinedTemplatesService();
