...
export const createPropertyRequiredMissingError = (propertyName: string): TAppError => {
  return createValidationError(
    `${DATABASE_ERROR_MESSAGES.PROPERTY_REQUIRED_MISSING}: ${propertyName}`,
    {
      field: propertyName,
...
export const createPropertyValidationFailedError = (
  propertyName: string,
  reason: string
): TAppError => {
  return createValidationError(
    `${DATABASE_ERROR_MESSAGES.PROPERTY_VALIDATION_FAILED}: ${propertyName} - ${reason}`,
    {
      field: propertyName,
...
export const createRecordValidationFailedError = (
...
export const createInvalidFilterOperatorError = (
  operator: string,
  propertyType: string
): TAppError => {
  return createValidationError(
    `Invalid filter operator '${operator}' for property type '${propertyType}'`,
    {
      field: 'operator',
...
export const createInsufficientPermissionsWithRequirementError = (
