...
export const createRelation = catchAsync(async (req: Request, res: Response): Promise<void> => {
...
export const createConnection = catchAsync(async (req: Request, res: Response): Promise<void> => {
...
export const removeConnection = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const { relationId } = req.params;
  const { sourceRecordId, targetRecordId } = req.body;

  await relationService.removeConnection(relationId, sourceRecordId, targetRecordId);
...
// Delete relation
export const deleteRelation = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const { relationId } = req.params;
  const userId = getUserId(req);
...
export const calculateRollup = catchAsync(async (req: Request, res: Response): Promise<void> => {
...
export const recalculateRollups = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const { databaseId } = req.params;
...
export const getRelationSchema = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const { databaseId } = req.params;
...
export const validateRelation = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const relationData: ICreateRelationRequest = req.body;
...
export const getRelationStats = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const { relationId } = req.params;
