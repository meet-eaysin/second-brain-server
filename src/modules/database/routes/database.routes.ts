...
import { validateBody, validateQuery, validateParams } from '../../../middlewares/validaation';
...
router.put('/:id/properties/:propertyId',
  authenticateToken,
...
router.get('/:id/records/:recordId',
  authenticateToken,
...
router.delete('/:id/share/:targetUserId',
  authenticateToken,
