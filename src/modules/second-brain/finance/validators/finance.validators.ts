...
export const getTransactionsQuerySchema = z.object({
  ...
  type: z.array(z.nativeEnum(ETransactionType)).or(
    z.string().transform(val => val.split(',').map(s => s.trim() as ETransactionType))
  ).optional(),
  category: z.array(z.nativeEnum(ETransactionCategory)).or(
    z.string().transform(val => val.split(',').map(s => s.trim() as ETransactionCategory))
  ).optional(),
  accountId: z.string().optional(),
  budgetId: z.string().optional(),
  goalId: z.string().optional(),
  projectId: z.string().optional(),
  minAmount: z.number().min(0).or(z.string().transform(val => parseFloat(val))).optional(),
  maxAmount: z.number().min(0).or(z.string().transform(val => parseFloat(val))).optional(),
  ...
  isRecurring: z.boolean().or(z.string().transform(val => val === 'true')).optional(),
  isVerified: z.boolean().or(z.string().transform(val => val === 'true')).optional(),
...
export const updateAccountSchema = z.object({
  ...
  type: z.nativeEnum(EAccountType).optional(),
...
export const createBudgetSchema = z.object({
  ...
  period: z.nativeEnum(EBudgetPeriod),
...
export const updateBudgetSchema = z.object({
  ...
  period: z.nativeEnum(EBudgetPeriod).optional(),
  startDate: z.string().datetime().transform(val => new Date(val)).optional(),
  endDate: z.string().datetime().transform(val => new Date(val)).optional(),
  currency: z.string().length(3, 'Currency must be 3 characters').optional(),
  isActive: z.boolean().optional(),
...
export const createFinancialGoalSchema = z.object({
  ...
  type: z.nativeEnum(EFinancialGoalType),
...
export const updateFinancialGoalSchema = z.object({
  ...
  type: z.nativeEnum(EFinancialGoalType).optional(),
