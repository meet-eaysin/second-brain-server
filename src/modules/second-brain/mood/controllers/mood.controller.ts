...
export const createMoodEntry = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    const entry = await createMoodEntryService(data, userId);
...
export const getMoodEntries = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    const result = await getMoodEntriesService(params, userId);

    sendPaginatedResponse(res, 'Mood entries retrieved successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
...
export const getMoodEntryById = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    const entry = await getMoodEntryByIdService(id, userId);
...
export const updateMoodEntry = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    const entry = await updateMoodEntryService(id, data, userId);
...
export const deleteMoodEntry = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    await deleteMoodEntryService(id, userId, permanent === 'true');
...
export const getMoodAnalytics = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    const analytics = await getMoodAnalyticsService(params, userId);
...
export const getPositiveMoods = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, 'Positive mood entries retrieved successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const getNegativeMoods = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, 'Negative mood entries retrieved successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const getTodaysMood = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, "Today's mood entries retrieved successfully", result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const getWeeklyMoods = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, 'Weekly mood entries retrieved successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const getMonthlyMoods = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, 'Monthly mood entries retrieved successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const searchMoodEntries = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    sendPaginatedResponse(res, 'Mood entry search completed successfully', result.entries, {
      total: result.total,
      page: result.page,
      limit: result.limit,
      totalPages: Math.ceil(result.total / result.limit),
...
export const moodCheckIn = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    const { databaseId, overallMood, energyLevel, stressLevel, gratitude } = req.body;
    const userId = getUserId(req);
