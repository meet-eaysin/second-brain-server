...
export const createTaskSchema = z.object({
  ...
  status: z.enum(EStatus).default(EStatus.NOT_STARTED),
  priority: z.enum(EPriority).default(EPriority.MEDIUM),
...
export const updateTaskSchema = z.object({
  name: z
    ...
    .optional(),
  description: z.string().max(2000, 'Description cannot exceed 2000 characters').trim().optional(),
  status: z.enum(EStatus).optional(),
  priority: z.enum(EPriority).optional(),
  dueDate: z.string().datetime().optional().or(z.date().optional()),
  startDate: z.string().datetime().optional().or(z.date().optional()),
  estimatedHours: z.number().min(0, 'Estimated hours must be positive').optional(),
...
export const getTasksQuerySchema = z.object({
  ...
  sortBy: z
    .enum(['name', 'dueDate', 'priority', 'status', 'createdAt', 'updatedAt'])
    .default('updatedAt'),
