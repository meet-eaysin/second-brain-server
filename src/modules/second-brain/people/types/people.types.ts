...
export const PersonSchema = z.object({
  ...
  status: z.nativeEnum(ERelationshipStatus),
  relationshipNotes: z.string().max(1000).optional(),
  howWeMet: z.string().max(500).optional(),
  metDate: z.date().optional(),
  communicationPreference: z.array(z.nativeEnum(ECommunicationPreference)),
...
export const UpdatePersonRequestSchema = CreatePersonRequestSchema.omit({ databaseId: true }).partial();
