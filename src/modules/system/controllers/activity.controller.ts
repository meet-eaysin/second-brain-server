...
export const recordPageVisit = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getRecentlyVisited = async (req: Request, res: Response, next: NextFunction) => {
  try {
